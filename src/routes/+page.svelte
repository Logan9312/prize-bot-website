...
<div class="bg-white">
	<div class="relative isolate px-6 pt-14 lg:px-8">
		...
		<div class="flex justify-center">
			<div class="flex max-w-4xl flex-row items-center py-32 sm:py-48 lg:py-56">
				<div class="text-left">
					<h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
						Community Rewards Made Easy
					</h1>
					<p class="mt-6 text-lg leading-8 text-gray-600">
						Prize Bot helps you manage your prizes so that you can focus on running quality events
						for your members and save time tracking the winners.
					</p>
				...
				<div class="mx-10 max-h-[500px]">
					<img src={Example} alt="Prize Bot Example" class="h-full w-auto rounded-xl" />
				</div>
			</div>
		</div>
		<div
